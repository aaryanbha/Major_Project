...
//
// class SingleTestResultsPassFourScreen extends StatelessWidget {
//   final String responseNumber;
//   const SingleTestResultsPassFourScreen({Key? key, required this.responseNumber}) : super(key: key);
//   @override
...
class SingleTestResultsPassFourScreen extends StatelessWidget {
  ...
  const SingleTestResultsPassFourScreen({Key? key,  this.responseNumber=123}) : super(key: key);
            ...
            buttonStyle: CustomButtonStyles.fillRed,
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => TypeOfMeasurementsEightScreen(),
                  ),
                );
              }
          ),
