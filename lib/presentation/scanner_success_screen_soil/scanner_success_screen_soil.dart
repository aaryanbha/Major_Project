...
class ScannerSuccessScreenSoil extends StatefulWidget {
  const ScannerSuccessScreenSoil({Key? key}) : super(key: key);
  @override
  _ScannerSuccessScreenSoilState createState() => _ScannerSuccessScreenSoilState();
}

class _ScannerSuccessScreenSoilState extends State<ScannerSuccessScreenSoil> {
  File? _image;
  int? _apiResponse;
