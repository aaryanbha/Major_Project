...
//   const SingleTestResultsPassFiveScreen({Key? key, this.responseNumber = '56.135'}) : super(key: key);
//   @override
...
class SingleTestResultsPassFiveScreen extends StatelessWidget {
  ...
  const SingleTestResultsPassFiveScreen({Key? key, this.responseNumber= 123}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
                    ...
                    child: Column(
                      children: [
                        Container(
                          height: 268.adaptSize,
                          width: 268.adaptSize,
                          padding: EdgeInsets.symmetric(horizontal: 56.h, vertical: 46.v),
          ...
          child: CustomElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => TypeOfMeasurementsSevenScreen(),
                ),
              );
            },
          ),
